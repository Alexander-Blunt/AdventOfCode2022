...
internal class Program
{
    ...
    {
        string fileLocation = InputProcessing.GetInputFilePath("\\ReorganizeRucksack", "Day3input.txt");
        Console.WriteLine(Rucksack.FindDuplicates(fileLocation));
        Console.WriteLine(Rucksack.FindBadges(fileLocation));
    }
}
